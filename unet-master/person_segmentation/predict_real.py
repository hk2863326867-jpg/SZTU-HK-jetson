...
print("=" * 70)
print("     Real-Style U-Net Prediction")
print("=" * 70)
print()

# 加载模型
print("[1/2] Loading real-style model...")

if not os.path.exists('real_unet.keras'):
    print("✗ Model not found: real_unet.keras")
    print("Please run: python train_real.py")
    sys.exit(1)

model = unet_rgb()
model.load_weights('real_unet.keras')
print("✓ Model loaded from real_unet.keras")
print()
...
for img_file, pred in results:
    ...
    output_name = f"{base_name}_real.png"
...
print("=" * 70)
print()
print("Results saved with '_real.png' suffix")
print()
