...
# 设置模型路径
full_model_path = './training/saved_models/pytorch_unet_v3_final.pth'
encoder_save_path = 'saved_weights/encoder_weights.pth'
decoder_save_path = 'saved_weights/decoder_weights.pth'
