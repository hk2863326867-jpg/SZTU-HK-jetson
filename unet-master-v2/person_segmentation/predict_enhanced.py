...
print("=" * 70)
print("     Enhanced U-Net Prediction")
print("=" * 70)
print()

# 加载模型
print("[1/2] Loading enhanced model...")

if not os.path.exists('enhanced_unet.keras'):
    print("✗ Model not found: enhanced_unet.keras")
    print("Please run: python train_enhanced.py")
    sys.exit(1)

model = unet_rgb()
model.load_weights('enhanced_unet.keras')
print("✓ Model loaded from enhanced_unet.keras")
print()
...
for img_file, pred in results:
    ...
    output_name = f"{base_name}_enhanced.png"
...
print("=" * 70)
print()
print("Results saved with '_enhanced.png' suffix")
print()
print("Compare the results:")
print("  - Original U-Net: *_predict.png")
print("  - Enhanced U-Net: *_enhanced.png")
print()
