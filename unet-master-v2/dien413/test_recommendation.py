...
def test_recommendation():
    ...
    test_users = [
        {
            'user_id': '1000001',
            'history': {
                'items': ['3108855', '2640191', '2203057'],  # 示例商品ID
                'categories': ['794437', '794437', '794437']  # 示例类别ID
            }
        },
        {
            'user_id': '1000002',
            'history': {
                'items': ['2735466', '1522137', '1461353'],
                'categories': ['1464116', '1464116', '1464116']
            }
        }
    ]
    ...
    # 候选商品池
    candidate_items = [
        '3108855', '2640191', '2203057', '2735466', '1522137',
        '1461353', '1326297', '1092131', '3007141', '2146619'
    ]
    candidate_categories = [
        '794437', '794437', '794437', '1464116', '1464116',
        '1464116', '4145810', '4145810', '4145810', '4145810'
    ]
    
    # 为每个用户生成推荐
    for user in test_users:
        print(f"\n用户 {user['user_id']} 的推荐结果:")
        predictions = batch_predict(
            sess, model, user['user_id'], candidate_items, candidate_categories,
            user['history']['items'], user['history']['categories'],
            uid_voc, mid_voc, cat_voc
        )
        
        # 输出Top-3推荐
        print("Top 3 推荐商品:")
        for i, (item_id, prob) in enumerate(predictions[:3]):
            print(f"{i+1}. 商品ID: {item_id}, 预测概率: {prob:.4f}")
